...
describe('Auth Store', () => {
  ...
  describe('Login', () => {
    it('should login successfully', async () => {
      ...
      (api.login as jest.Mock).mockResolvedValue({ access_token: mockToken, token_type: 'bearer' });
  ...
  describe('Register', () => {
    it('should register and login successfully', async () => {
      ...
      await act(async () => {
        await result.current.register({ email: 'test@example.com', password: 'password123', full_name: 'Test User' });
      });
  ...
  describe('Check Auth', () => {
    it('should restore auth state from localStorage', () => {
      ...
      const mockUser = { id: 1, email: 'test@example.com', full_name: 'Test User', is_admin: false };
